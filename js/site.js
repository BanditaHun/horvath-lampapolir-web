...
function renderContact(app, contact) {
  ...
  const billingNotice = `<div class="container"><section class="billing-notice">
      ...
      <p>Vállalkozásunk <strong>minden értékesítésről és szolgáltatásról számlát állít ki</strong>. A számla kiállításához és a szolgáltatáshoz a megrendeléskor (személyesen, telefonon vagy e-mailben) az alábbi adatokat kérjük:</p>
      <ul class="billing-notice__list">
        <li><strong>Magánszemélyeknek:</strong> név, cím (lakcím), telefonszám és az autó típusa.</li>
        <li><strong>Cégeknek / vállalkozóknak:</strong> cégnév, székhely (számlázási cím), adószám, telefonszám és az autó típusa.</li>
      </ul>
